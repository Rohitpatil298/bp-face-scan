...
# 0.75 Hz  →  45 BPM   (lower physiological limit - resting)
# 2.5 Hz   → 150 BPM   (upper limit - prevents harmonic detection)
# Narrower range reduces false high readings from harmonics
BP_LOW_HZ: float = 0.75
BP_HIGH_HZ: float = 2.5
...
# Reduced to 3 for short scan compatibility (45s scans)
HRV_MIN_PEAKS: int = 3
